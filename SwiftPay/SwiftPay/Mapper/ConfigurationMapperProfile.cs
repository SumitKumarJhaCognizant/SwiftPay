	...
	public class ConfigurationMapperProfile : Profile
	{
		public ConfigurationMapperProfile()
		{
			...
			CreateMap<RemittanceRequest, CreateRemittanceResponseDto>()
				...
				.ForMember(dest => dest.BeneficiaryName, opt => opt.MapFrom(src => src.Beneficiary != null ? src.Beneficiary.Name : null))
				.ForMember(dest => dest.BeneficiaryCountry, opt => opt.MapFrom(src => src.Beneficiary != null ? src.Beneficiary.Country : null))
				.ForMember(dest => dest.BeneficiaryBank, opt => opt.MapFrom(src => src.Beneficiary != null ? src.Beneficiary.BankName : null))
				.ForMember(dest => dest.BeneficiaryAccount, opt => opt.MapFrom(src => src.Beneficiary != null ? src.Beneficiary.AccountOrWalletNo : null));
